...
bool produit::ajouter(){
    ...
    query.prepare("INSERT INTO produit (reference,nom,type,nature,quantite,prix,prix_fid) VALUES (:reference,:nom,:type,:nature,:quantite,:prix,:prix_fid)");
...
bool produit::modifier(QString selected){
    ...
    query.prepare(" UPDATE produit SET  nom=:nom, type=:type, nature=:nature, quantite=:quantite, prix=:prix, prix_fid=:prix_fid"
