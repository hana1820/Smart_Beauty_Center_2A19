...
q2.prepare("SELECT * FROM produit WHERE type='type 1'");
q2.exec();

q3.prepare("SELECT * FROM produit WHERE type='type 2'");
q3.exec();

q4.prepare("SELECT * FROM produit WHERE type='type 3' ");
q4.exec();

q5.prepare("SELECT * FROM produit WHERE type='type 4' ");
q5.exec();
...
//pie chart
    ...
    q2.prepare("SELECT * FROM produit WHERE quantite between 0 and 1000");
    q2.exec();

    q3.prepare("SELECT * FROM produit WHERE quantite between 1001 and 2000");
    q3.exec();

    q4.prepare("SELECT * FROM produit WHERE quantite > 2000 ");
    q4.exec();
